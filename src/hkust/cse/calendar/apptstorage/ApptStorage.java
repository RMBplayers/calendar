...
public abstract class ApptStorage implements Serializable{
	...
	public Vector<Location> locationList;
	...
	*/
	...
	public abstract Vector<Location> getLocationList();
	...
	*/
	...
	locationList = new Vector<Location>(0);
	}
	...
	public abstract Appt[] RetrieveAppts(User entity, TimeSpan time, boolean a);	//overloading abstract method to retrieve an appointment record by a given user object and timespan
